    ...
    <div class="row border p-4 shadow-sm rounded-4" style="background-color: #fdfdfd;">
        <form id="join" method="post" name="formm">
            ...
            <div class="col-md-12 mt-10">
                <textarea name="content" class="form-control border-dark-subtle text-dark" rows="15">
                    제 1 장 총 칙
                ...
                <input type="button" value="Next" class="btn btn-secondary" onclick="go_next()" style="float: right;">
            </div>
        </form>
    </div>
</div>
